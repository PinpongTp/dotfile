...
keymap('n', '<leader>dh', function() require "dap".toggle_breakpoint() end)
keymap('n', '<leader>dH', ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>")
keymap('n', '<A-k>', function() require "dap".step_out() end)
keymap('n', "<A-l>", function() require "dap".step_into() end)
keymap('n', '<A-j>', function() require "dap".step_over() end)
keymap('n', '<A-h>', function() require "dap".continue() end)
keymap('n', '<leader>du', function() require "dap".up() end)
keymap('n', '<leader>dd', function() require "dap".down() end)
keymap('n', '<leader>dn', function() require "dap".run_to_cursor() end)
--vim.keymap.set('n', '<leader>dc', function() require "dap".terminate() end)
keymap('n', '<leader>dR', function() require "dap".clear_breakpoints() end)
keymap('n', '<leader>de', function() require "dap".set_exception_breakpoints({ "all" }) end)
