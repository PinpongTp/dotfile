...
nvim_lsp.efm.setup {
  ...
  settings = {
    ...
    languages = {
      lua = {
        {
          -- lua-format install by cargo and cmake, cargo and cmake install by brew
          formatCommand = "lua-format -i --indent-width=2 --continuation-indent-width=2 --tab-width=2",
          formatStdin = true
        }
      }
    }
...
local eslint = {
  ...
  lintStdin = true,
  lintFormats = {"%f:%l:%c: %m"},
  rootMarkers = {".eslintrc", ".eslintrc.json", ".eslintrc.js", "package.json"}
}
    ...
    init_options = {
      linters = {
        eslint = {
          ...
          -- command = 'eslint',
          rootPatterns = {
            '.git', '.eslitrc.js', '.eslintrc.js', '.eslintrc.json',
            'package.json'
          },
          debounce = 100,
          args = {
